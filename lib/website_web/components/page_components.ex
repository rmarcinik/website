defmodule WebsiteWeb.PageComponents do
  ...
  def page_layout(assigns) do
    ...
    <div class="page-layout">
      ...
      <%= if @content != [] do %>
        <div class="content-panel">{render_slot(@content)}</div>
      <% else %>
    ...
    <%= if @stats do %>
      <div class="github-stats">
        <div class="stats-grid">
          <div class="stats-row">
            <span class="stats-label">stars</span> <span class="stats-value">{@stats.stars}</span>
          </div>
          
          <div class="stats-row">
            <span class="stats-label">forks</span> <span class="stats-value">{@stats.forks}</span>
          </div>
          
          <div class="stats-row">
            <span class="stats-label">issues</span> <span class="stats-value">{@stats.issues}</span>
          </div>
        ...
        <%= if length(@stats.commit_grid) > 0 do %>
          <div class="commit-grid">
           ...
           <.commit_mesh commit_grid={@stats.commit_grid} />
        <% end %>
